...
namespace listen_LogInInfo
{
   class listen
   {
      ...
      static void Main(string[] args)
      {
         ...
         string appName = "listen-LogInInfo-Sharp";
         appName += pid;
         #endregion
      ...
      void init(ExerciseConnection exConn)
      {
         ...
         exConn.addMessageHandler(UniversalHlaInteractionMessage.theName, myDelegate, "HLAinteractionRoot.LogInInfo");
      }
 
      internal void processMessage(Message m)
      {
         UniversalHlaInteractionMessage intrMsg = m as UniversalHlaInteractionMessage;
         LogInInfoInteractionClass intr = new LogInInfoInteractionClass();
