...
// Define a callback to process PowerCtrlInter interactions.
void simpleCallback(DtPowerCtrlInter* inter, void* /*usr*/)
{
   std::cout << "Received PowerCtrlInter Interaction." << std::endl;
...
int main(int argc, char** argv)
{
   try
   {
     ...
     // appear if a federate is not RPR based.
      ...
      DtPowerCtrlInter::addCallback(&exConn, simpleCallback, NULL);
